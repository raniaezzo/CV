...
\begin{cventries}
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Focus on the early cortical stages of visual processing, with an emphasis on how the human brain encodes motion using a range of methods, including psychophysics, virtual reality and functional MRI.}
      \end{cvitems}
    }
  \cventry
